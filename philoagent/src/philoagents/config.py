...
class Settings(BaseSettings):
    ...
    # --- GROQ Configuration ---
    GROQ_API_KEY: Optional[str] = None # Set to None for local dev
    ...
    MONGO_URI: str = Field(
        default="mongodb://philoagents:philoagents@localhost:27017/?directConnection=true", # this local connection need to changed when ruunig indide docker
...
# --- VERIFICATION BLOCK (Temporary) ---
print("\n--- Settings Verification ---")
if settings.GROQ_API_KEY:
    # Print the key, but mask it for security
    print(f"GROQ_API_KEY loaded successfully. Starts with: {settings.GROQ_API_KEY[:4]}...{settings.GROQ_API_KEY[-4:]}")
else:
    print("WARNING: GROQ_API_KEY is NOT loaded. It is currently None.")
print("---------------------------\n")
